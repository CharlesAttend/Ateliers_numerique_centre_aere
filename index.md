...
- [2. Activité proposée](#2-activité-proposée)
    ...
    - [2.5. Dessin sur tablette graphique](#25-dessin-sur-tablette-graphique)
        - [2.5.1. Matériel](#251-matériel)
        - [2.5.2. Description](#252-description)
    - [2.6. Dessins en Réalité augmenté](#26-dessins-en-réalité-augmenté)
        - [2.6.1. Matériel](#261-matériel)
        - [2.6.2. Description](#262-description)
        - [2.6.3. Déroulement](#263-déroulement)
    - [2.7. Crayons d'impression 3D](#27-crayons-dimpression-3d)
        - [2.7.1. Matériel](#271-matériel)
        - [2.7.2. Description](#272-description)
        - [2.7.3. Déroulement](#273-déroulement)
    - [2.8. Modélisation et impression 3D](#28-modélisation-et-impression-3d)
        - [2.8.1. Matériel](#281-matériel)
        - [2.8.2. Description](#282-description)
        - [2.8.3. Déroulement](#283-déroulement)
    - [2.9. Atelier code](#29-atelier-code)
        - [2.9.1. Matériel](#291-matériel)
        - [2.9.2. Description](#292-description)
        - [2.9.3. Déroulement](#293-déroulement)
    - [2.10. Carte micro:bit](#210-carte-microbit)
        - [2.10.1. Matériel](#2101-matériel)
        - [2.10.2. Description](#2102-description)
        - [2.10.3. Déroulement](#2103-déroulement)
...
## 2.5. Dessin sur tablette graphique
### 2.5.1. Matériel
- 3 tablettes graphique
- 3 PC
...
## 2.6. Dessins en Réalité augmenté
### 2.6.1. Matériel
- Smartphone
- Internet
...
1. Choix d’un dessin à reproduire (sur internet puis impression, ou parmi ceux proposé)
   Ou sculture qu'importe
2. Faire le dessin en décalquant

## 2.8. Modélisation et impression 3D
### 2.8.1. Matériel
- Ordinateur
### 2.8.2. Description
...
## 2.9. Atelier code
> <span style="color:red;">Au final ils ont déjà fait ça au collège => Annulé </span>
### 2.9.1. Matériel
- Smartphone
...
## 2.10. Carte micro:bit
### 2.10.1. Matériel
- Carte micro:bit
- Smartphone ou ordinateur

### 2.10.2. Description
L'idée est qu'avec ce que les enfants ont appris avec l'activité précédente, il programme la carte pour faire un peu ceux qu'ils veulent. Il y a plein de tutoriel et de mini projet sur le [site web](https://makecode.microbit.org/).

### 2.10.3. Déroulement
1. Je leurs montre le site
2. On fait quelques tutos de base (coeur clignotant et pierre feuille ciseau)
3. Ils choisisent et réalise un projet pas trop dur
4. On flash les cartes pour avoir le projet qui fonctionne dans la main
